...
class ArtikelAdapter(private val listArtikel : ArrayList<Artikel>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.imageArtikel.setImageResource(listArtikel[position].imageArtikel)
        holder.imageArtikel.setOnClickListener {
            ...
            intent.putExtra(DetailArtikelActivity.DATA_IMG,listArtikel[position].imageArtikel)
